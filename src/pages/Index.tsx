...
const courses: Course[] = [
  {
    id: "ai-medicine",
    title: "AI в медицине",
    description: "Искусственный интеллект трансформирует современную медицину, открывая новые возможности для диагностики, лечения и управления медицинскими процессами. AI-технологии помогают оптимизировать работу медицинских учреждений, повышать точность диагностики и улучшать качество обслуживания пациентов. Цель курса – формирование компетенций по внедрению AI-решений в медицинскую практику для повышения эффективности диагностики, лечения и управления медицинскими процессами.",
    field: "Медицина",
    duration: "1 день",
    format: ["Очно", "Онлайн"],
    speakers: [
